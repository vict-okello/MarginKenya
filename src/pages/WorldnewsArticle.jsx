...
function WorldnewsArticle() {
  const { articleId } = useParams();
  const article = worldNewsArticles.find((item) => item.id === articleId);

  if (!article) {
    return <NotFoundMessage backTo="/worldnews" backLabel="Back to World News" />;
  }
...
export default WorldnewsArticle;
