...
import { politicsArticles } from "../data/politicsArticles";
...
function PoliticsArticle() {
  ...
  const article = politicsArticles.find((item) => item.id === articleId);

  if (!article) {
    return <NotFoundMessage backTo="/politics" backLabel="Back to Politics" />;
  }
