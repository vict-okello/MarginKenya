        ...
        <div className="mt-3 border-t border-black/35 pt-3">
          <div className="flex flex-col items-start justify-between gap-3 border-b border-black/35 pb-3 text-xs text-black/70 md:flex-row md:items-center">
            ...
            <div className="flex items-center gap-3 text-black/80">
              <a href="https://www.instagram.com/" aria-label="Instagram" target="_blank" rel="noreferrer" className="hover:text-black">
              ...
              <a href="https://www.linkedin.com/" aria-label="LinkedIn" target="_blank" rel="noreferrer" className="hover:text-black">
                <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current">
              ...
              <a href="https://www.youtube.com/" aria-label="YouTube" target="_blank" rel="noreferrer" className="hover:text-black">
                <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current">
              ...
              <a href="https://x.com/" aria-label="X" target="_blank" rel="noreferrer" className="hover:text-black">
                <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current">
                  <path d="M18.9 2H22l-6.8 7.8L23 22h-6.1l-4.8-6.3L6.6 22H3.5l7.3-8.3L1 2h6.3l4.3 5.7zm-1.1 18h1.7L6.4 3.9H4.6z" />
                </svg>
              </a>
              <a href="https://www.reddit.com/" aria-label="Reddit" target="_blank" rel="noreferrer" className="hover:text-black">
                <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current">
