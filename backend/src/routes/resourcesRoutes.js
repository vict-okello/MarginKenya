...
function normalizeResources(payload) {
  ...
  return list.map((item, idx) => ({
    ...
    author: cleanSingleLine(item?.author || item?.authorName, 120),
    authorName: cleanSingleLine(item?.authorName || item?.author, 120),
    authorRole: cleanSingleLine(item?.authorRole, 120),
    authorBio: cleanMultiline(item?.authorBio, 3000),
